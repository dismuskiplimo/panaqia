                ...
                <div class="col-sm-6 col-sm-offset-3">
                    <div class="custom-card">
                        <div class="card-inner">
                            <h3 class="text-center"><strong>{{ strtoupper($title) }}</strong> <br><br> PAYMENT FOR ATTENDING THE EVENT <br>  <strong>{{ strtoupper($event_request->event->name) }}</strong></h3>
                            ...
                            <ol>
                                ...
                                <li><strong>{{ $options->currency }} {{ number_format($event_request->amount_due, 2) }}</strong> Will be deducted automatically.</li>
                            ...
                            <form action="{{ route('user.mpesa.request', ['id' => $event_request->id, 'type' => 'ticket']) }}" method="POST">
                                @csrf
